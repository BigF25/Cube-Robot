...
typedef struct {
   ...
   */
  Ushort quantval[DCTSIZE2];	/* quantization step for each coefficient */
...
#define jpeg_stdio_destf  jStdDestf
#define jpeg_stdio_srcf  jStdSrcf
...
EXTERN(void) jpeg_stdio_destf JPP((j_compress_ptr cinfo, XXX_JPEG_FILE_BUFFER * outbuffer));
EXTERN(void) jpeg_stdio_srcf JPP((j_decompress_ptr  cinfo, XXX_JPEG_BUFFER * inbuffer));
